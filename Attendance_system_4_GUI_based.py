...
filePathAT1='./new_database/Student_Images/Section A/T 1'
filePathAT2='./new_database/Student_Images/Section A/T 2'
filePathCT3='./new_database/Student_Images/Section C/T 3'
filePathCT4='./new_database/Student_Images/Section C/T 4'
...
if session_type=="THEORY":
    record_path="./new_database/attendance_record/"+subject_code+"/"+session_type+"/"+section+".csv"
elif session_type=="LAB":
    record_path="./new_database/attendance_record/"+subject_code+"/"+session_type+"/"+category+".csv"
        ...
        for face_encoding in face_encodings:
            ...
            if enrol_num in all_enrollment_numbers:
                if enrol_num in marked:
                    ...
                    playsound('C:/./message-incoming-132126.mp3')
